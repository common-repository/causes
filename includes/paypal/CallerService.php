...
****************************************************/
/// check for live/sandbox
if(get_option('enable_live')==1): 
	require_once plugin_dir_path(__DIR__) .'paypal/constants_live.php'; 
	else:
	
	require_once plugin_dir_path(__DIR__) .'paypal/constants_sandbox.php';
   ...
   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
	...
	if (curl_errno($ch)) {
		// moving to display page to display curl errors
		  ...
		  $location =  plugin_dir_path(__DIR__) .'/includes/paypal/paypal/APIError.php';
